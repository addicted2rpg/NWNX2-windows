...
static char (__fastcall *CNWSModule__UpdateTimeNEXT)(CNWSModule *pTHIS, void *pVOID, int a2, int i, int a4);
...
private:
	...
	DWORD CNWSModule__UpdateTimeORG;
	...
	static char __fastcall CNWSModule__UpdateTimeHOOK(CNWSModule *pTHIS, void *pVOID, int a2, int i, int a4);
